...
public class WeightList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editAccountButton = findViewById(R.id.editAccountBtn);
        editAccountButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WeightList.this, EditAccount.class);
                intent.putExtra("text_data", usernameT);
                startActivity(intent);
            }
        });
    ...
    protected void onResume() {
        ...
        String newUsername = sharedPreferences.getString("new_username", null);
        if(newUsername != null) {
            usernameT = newUsername;
            SharedPreferences.Editor editor = sharedPreferences.edit();
            editor.remove("new_username");
            editor.apply();
        }
    }
